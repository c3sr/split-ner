...
```commandline
cd secner
CUDA_VISIBLE_DEVICES=0,1 python main.py config.json
```
#### Base Models
...
|-------|-----------|-----------|-----------|-----------|
| Pipeline(QA-QA) | p: 87.55, r: 89.53, f1: 88.53 | p: 88.65, r: 90.37, f1: 89.50 | p: 88.18, r: 90.08, f1: 89.12 | p: 88.31, r: 90.35, f1: 89.32 |
| Pipeline(QA_NoCharPattern-QA) | p: 87.76, r: 89.74, f1: 88.74 | p: 88.20, r: 90.22, f1: 89.20 | p: 87.92, r: 90.30, f1: 89.10 | p: 88.20, r: 90.36, f1: 89.27 |
| Pipeline(SeqTag-QA) | p: 87.52, r: 89.41, f1: 88.45 | p: 88.34, r: 90.49, f1: 89.40 | p: 88.10, r: 90.15, f1: 89.11 | p: 88.00, r: 90.23, f1: 89.10 |
| Single(QA) | - | - | - | - |
| Single(SeqTag) | p: 89.08, r: 89.27, f1: 89.17 | p: 86.59, r: 89.06, f1: 87.81 | p: 88.61, r: 89.37, f1: 88.99 | p: 88.34, r: 89.75, f1: 89.04 |
| SpanDetect(SeqTag) | p: 91.12, r: 92.48, f1: 91.79 | p: 91.30, r: 92.80, f1: 92.04 | p: 91.24, r: 92.58, f1: 91.90 | p: 90.93, r: 92.45, f1: 91.68 |
| SpanDetect(QA) | p: 91.01, r: 92.24, f1: 91.62 | p: 91.63, r: 92.60, f1: 92.11 | p: 91.20, r: 92.57, f1: 91.88 | p: 91.36, r: 92.73, f1: 92.04 |
| SpanDetect(QA_NoCharPattern) | p: 91.28, r: 92.56, f1: 91.91 | p: 91.23, r: 92.61, f1: 91.91 | p: 91.05, r: 92.88, f1: 91.96 | p: 91.15, r: 92.64, f1: 91.89 |
| SpanClass(Dice, QA) | p: 95.58, r: 95.58, f1: 95.58 | p: 96.19, r: 96.19, f1: 96.19 | p: 96.18, r: 96.18, f1: 96.18 | p: 96.23, r: 96.23, f1: 96.23 |
...
```shell script
CUDA_VISIBLE_DEVICES=0,1 python main_qa.py config/conll/config_bert_qa4_span_querytype4.json
```

For sequence labeling procedure using ```BIOE``` scheme, set ```"tagging": "bioe"``` along with ```"detect_spans": true```. Example run command:

```shell script
CUDA_VISIBLE_DEVICES=0,1 python main.py config/conll/config_bert_bioe_span.json
```
...
```shell script
CUDA_VISIBLE_DEVICES=0,1,2 python main_span.py config/bio/config_bert_spanclass_dice.json
```
...
```shell script
python analysis.py --dataset conll --model ner-bert-spanclass-dice --file infer
```
...
| Model (Test Span-Micro-Avg)                                               | BERT-Level F1 | Data-Level P | Data-Level R | Data-Level F1 |
|---------------------------------------------------------------------------|---------------|--------------|--------------|---------------|
| Span Detector(Roberta-QA4-QType4-Char-Pattern3-SubText-Dim50)*            | 57.753        | 56.5563      | 67.0195      | 61.3449       |
| Span Classifier(Dice)*                                                    | 81.198        | 82.2200      | 82.2200      | 82.2200       |
| Pipeline*                                                                 | 78.116        | 47.0840      | 57.1051      | 51.6126       |
...
| Span Detector(QA4-QType4-Char-Pat3-Dim50)*                                | run-123       | run-123      | run-123      | run-123       |
| Span Detector(BIOE-SeqTag)*                                               | 92.904        | 94.1774      | 93.6438      | 93.9098       |
| Span Classifier*                                                          | 94.016        | 93.8543      | 93.8543      | 93.8543       |
| Span Classifier(Dice)*                                                    | run-123       | run-123      | run-123      | run-123       |
...
| Pipeline(Det:QA4-QType4-Char-Pat3-Dim50, Class:Dice)*                     | run-123       | run-123      | run-123      | run-123       |
...
| Span Detector(QA4-QType4-Char-Pattern3-SubText-Dim50)*                    | 88.433/run-123| 89.3452/run-123      | 88.2327/run-123      | 88.7855/run-123       |
| Span Classifier*                                                          | 95.070        | 95.1081      | 95.1081      | 95.1081       |
| Span Classifier(Dice)*                                                    | 95.096(123)   | 95.1170(123) | 95.1170(123) | 95.1170(123)  |
| Pipeline*                                                                 | 94.348        | 84.9409      | 87.1461      | 86.0294       |
| Pipeline(Det:QA4-QType4-Char-Pat3-SubText-Dim50)*                         | 94.462        | 85.6255      | 86.6163      | 86.1180       |
| Pipeline(Det:QA4-QType4-Char-Pat3-Dim50, Class:Dice)*                     | run-123       | run-123      | run-123      | run-123       |
...
| Model (Test Span-Micro-Avg)                                               | BERT-Level F1 | Data-Level P | Data-Level R | Data-Level F1 |
|---------------------------------------------------------------------------|---------------|--------------|--------------|---------------|
| Span Detector(Roberta-QA4-QType4-Char-Pattern3-SubText-Dim50)*            | 89.199        | 89.2549      | 90.1361      | 89.6933       |
| Span Classifier(Dice)*                                                    | 94.874        | 94.9124      | 94.9124      | 94.9124       |
| Pipeline*                                                                 | 93.919        | 85.2475      | 86.9632      | 86.0968       |
 
#### Onto-Final (10% Cross Validation Setting)
 
| Dataset                                               | Data-Level P | Data-Level R | Data-Level F1 |
|-------------------------------------------------------|--------------|--------------|---------------|
| Part0                                                 | 85.4947      | 87.0637      | 86.2721       |
| Part1                                                 | 84.5909      | 85.9194      | 85.2500       |
| Part2                                                 | 84.8418      | 86.5582      | 85.6914       |
| Part3                                                 | 84.9780      | 86.7481      | 85.8539       |
| Part4                                                 | 84.9403      | 86.0289      | 85.4811       |
| Part5                                                 | 85.2165      | 87.0081      | 86.1030       |
| Part6                                                 | 84.6628      | 86.2595      | 85.4537       |
| Part7                                                 | 84.8605      | 86.7486      | 85.7941       |
| Part8                                                 | 84.8660      | 87.0933      | 85.9652       |
| Part9                                                 | 84.2101      | 86.4420      | 85.3115       |
| Avg                                                   | **84.8662**  | **86.5870**  | **85.7176**   |
...
| Span Detector(QA4-QType4-Char-Pat3-Dim50)*                                | 79.302(123)   | 76.0897(123) | 77.5627(123) | 76.8191(123)  |
...
| Span Detector(QA4-QType4-Char-Pat3-Dim50)*                                | 44.738(123)   | 66.1562(123) | 40.0742(123) | 49.9133(123)  |
| Span Classifier                                                           | 62.095        | 62.0945      | 62.0945      | 62.0945       |
| Span Classifier(Dice)*                                                    | 64.319(123)   | 64.3188(123) | 64.3188(123) | 64.3188(123)  |
| Pipeline                                                                  | 70.939        | 50.9834      | 49.3411      | 50.1488       |
| Pipeline(Det:QA4-QType4-Char-Pat3-Dim50, Class:Dice)*                     | 72.344(123)   | 50.2297(123) | 47.2622(123) | 48.7008(123)  |
...
| Span Detector(QA4-QType4-Char-Pat3-Dim50)*                                | 96.355(123)   | 97.1729(123) | 97.2434(123) | 97.2081(123)  |
| Span Classifier*                                                          | 91.364        | 91.5851      | 91.5851      | 91.5851       |
| Span Classifier(Dice)*                                                    | 87.945(123)   | 87.8854(123) | 87.8854(123) | 87.8854(123)  |
| Pipeline*                                                                 | 92.006        | 90.6409      | 90.3448      | 90.4926       |
| Pipeline(Det:QA4-QType4-Char-Pat3-Dim50, Class:Dice)*                     | 87.769(123)   | 86.2269(123) | 86.4776(123) | 86.3521(123)  |
...
| Model (Test Span-Micro-Avg)                                               | BERT-Level F1 | Data-Level P | Data-Level R | Data-Level F1 |
|---------------------------------------------------------------------------|---------------|--------------|--------------|---------------|
| Span Detector (RoBERTa-Char-Pat3-QA4-QType4)                              | 91.638        | 91.7118      | 91.8260      | 91.7689       |
...
| Model (Test Span-Micro-Avg)                                                                          | BERT-Level F1 | Data-Level P | Data-Level R | Data-Level F1 |
|------------------------------------------------------------------------------------------------------|---------------|--------------|--------------|---------------|
| Span Detector (RoBERTa-Char-Pat3-QA4-QType4) [Train Time: 388225 sec, Batch Size: 12, on 5 GPUs]     | 92.368        | 92.1671      | 92.8311      | 92.4979       |
| Span Classifier (RoBERTa-Dice) [Train Time: 226,854 sec, Batch Size: 16, on 4 GPUs]                  | 96.740        | 96.7357      | 96.7357      | 96.7357       |
...
| Model (Test Span-Micro-Avg)                                               | BERT-Level F1 | Data-Level P | Data-Level R | Data-Level F1 |
|---------------------------------------------------------------------------|---------------|--------------|--------------|---------------|
| Span Detector(QA4-QType4-Char-Pattern3-SubText-Dim50)                     | 99.085        | 98.9154      | 99.2383      | 99.0766       |
| Span Classifier(Dice)                                                     | 95.065        | 95.0308      | 95.0308      | 95.0308       |
| Pipeline(Det:QA4-QType4-Char-Pattern3-SubText-Dim5)                       | 95.165        | 94.2155      | 94.5230      | 94.3690       |

#### Mit-Trivia

| Model (Test Span-Micro-Avg)                                               | BERT-Level F1 | Data-Level P | Data-Level R | Data-Level F1 |
|---------------------------------------------------------------------------|---------------|--------------|--------------|---------------|
| Span Detector(QA4-QType4-Char-Pattern3-SubText-Dim50)                     | 74.506        | 73.7561      | 74.0415      | 73.8985       |
| Span Classifier(Dice)                                                     | 95.867        | 95.8670      | 95.8670      | 95.8670       |
| Pipeline(Det:QA4-QType4-Char-Pattern3-SubText-Dim5)                       | 93.121        | 71.7239      | 72.2556      | 71.9887       |
...
| Model (Test Span-Micro-Avg)                                               | BERT-Level F1 | Data-Level P | Data-Level R | Data-Level F1 |
|---------------------------------------------------------------------------|---------------|--------------|--------------|---------------|
| Span Detector(QA4-QType4-Char-Pattern3-SubText-Dim50)                     | 53.569        | 73.3846      | 44.2486      | 55.2083       |
| Span Classifier(Dice)                                                     | 73.401        | 73.4013      | 73.4013      | 73.4013       |
| Pipeline(Det:QA4-QType4-Char-Pattern3-SubText-Dim5)                       | 76.649        | 59.8462      | 53.1421      | 56.2952       |
...
| Model (Test Span-Micro-Avg)                                               | BERT-Level F1 | Data-Level P | Data-Level R | Data-Level F1 |
|---------------------------------------------------------------------------|---------------|--------------|--------------|---------------|
| Span Detector(QA4-QType4-Char-Pattern3-SubText-Dim50)                     | 84.177        | 81.4665      | 82.8626      | 82.1586       |
| Span Classifier(Dice)                                                     | 94.129        | 94.1288      | 94.1288      | 94.1288       |
| Pipeline(Det:QA4-QType4-Char-Pattern3-SubText-Dim5)                       | 92.669        | 77.7847      | 79.2939      | 78.5320       |
