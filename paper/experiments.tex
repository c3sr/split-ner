...
BERT-Span-Pipeline     & 86.70 & 90.31 & 56.30  \\
Reported SOTA & 85.56(thesis see) & 92.07(MRC-Dice) & 60.45(CL-KL)  \\
\bottomrule
\end{tabular}
...
Reported SOTA & (no reports) & 86.9(few-shot-paper-unpublished) & 50.5(CL-KL)  \\
\bottomrule
\end{tabular}
...
\begin{tabular}{cccc}\toprule
 \textbf{Model} & \texttt{BioNLP13CG} & \texttt{OntoNotes} & \texttt{WNUT17} \\ \toprule 
QA & todo & todo & todo  \\
Span-Pipeline     & todo & todo & todo  \\
\bottomrule
\end{tabular}
\caption{Training Time Results. sec per training epoch\%.}
