...
BERT-QA & \textcolor{blue}{ongoing(j)} & \textcolor{blue}{ongoing(y1)} & \textcolor{blue}{ongoing(j)}  & 44.60 \\
...
\begin{tabular}{ccccc}\toprule
 \textbf{Model} & \texttt{BioNLP13CG} & \texttt{CyberThreats} & \texttt{OntoNotes} & \texttt{WNUT17} \\ \toprule 
Span-Detector-CharPattern & 91.06 & 78.63 \textcolor{blue}{ongoing(y4)}& 92.50 & 55.21  \\
Span-Detector-Vanilla     & 90.67 & 78.70 & \textcolor{blue}{ongoing(j)} & 54.85  \\
\bottomrule
\end{tabular}
