...
class PatternCNN(nn.Module):
    def __init__(self, inp_dim, conv1_dim, conv2_dim, fc1_dim, out_dim, kernel_size, word_len, word_vocab_size=None,
        ...
        # TODO: can add a LSTM/Conv layer (over words) here followed by only one FC layer (as is common practice)
...
class PatternCNNExecutor(BaseExecutor):
    ...
    def __init__(self, args):
        ...
        self.model = PatternCNN(inp_dim=self.train_dataset.inp_dim, conv1_dim=self.args.conv1_dim,
                                conv2_dim=self.args.conv2_dim, fc1_dim=self.args.fc1_dim,
...
if __name__ == "__main__":
    ...
    ap.add_argument("--conv2_dim", type=int, default=256, help="conv2 layer output channels (Default: 256)")
    ...
    ap.add_argument("--fc1_dim", type=int, default=512, help="fc1 layer output dimension (Default: 512)")
