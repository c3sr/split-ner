...
\begin{figure}
    \centering
    \includegraphics[scale=0.63]{question_answering}
...
\begin{itemize}
    ...
    \item \texttt{Special Symbol}: Same as \texttt{BERT} model with additional one-hot input feature to capture if the token is a special symbol like \textit{hyphen}, \textit{comma}, or \textit{parenthesis}.
